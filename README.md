...
Reasoning features are generated by an LLM and transformed into structured numerical attributes.
...
These features are merged using commit_id and used in Experiments 3, 5, 6 and 7.
...
```text
CodeBERT PCA Features (384 Dimensions)
```
