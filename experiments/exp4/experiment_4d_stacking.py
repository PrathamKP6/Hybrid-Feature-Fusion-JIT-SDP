...
OUTPUT_DIR = PROJECT_ROOT / "results" / "exp4" / "experiment_4d"
...
def main() -> None:
    ...
    save_predictions(predictions, PREDICTIONS_DIR / "experiment_4d_predictions.csv")

    logger.info("Experiment 4d complete. Results saved to %s", OUTPUT_DIR)
