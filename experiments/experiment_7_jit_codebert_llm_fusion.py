"""
EXPERIMENT 7: JIT + CODEBERT + LLM REASONING FEATURE FUSION
...
OUTPUT_DIR = (
    PROJECT_ROOT
    / "results"
    / "experiment_7_jit_codebert_llm_fusion"
)
...
"""
    ...
    with open(
        OUTPUT_DIR
        / "experiment_7_configuration.json",
        "w",
        encoding="utf-8",
    ) as f:
