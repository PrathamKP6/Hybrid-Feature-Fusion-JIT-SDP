"""
EXPERIMENT 7B: JIT + CODEBERT-25 + LLM REASONING FEATURE FUSION
...
OUTPUT_DIR = (
    PROJECT_ROOT
    / "results"
    / "experiment_7b_jit_codebert25_llm_fusion"
)
...
def main():
    ...
    print_header(
        "EXPERIMENT 7B: JIT + CODEBERT-25 + LLM "
...
Methodology:
  ...
  CodeBERT features used: first 25 PCA components
  LLM reasoning features: 51
  Total model features: 88
  PCA: 384 components
...
"""
    ...
    print(
        f"[OK] Experiment 7B will use first {CODEBERT_DIM} "
        f"PCA components."
    )
    ...
    metrics_json = {
        ...
        "methodology": {
            ...
            "pca":
                "384 components; first 25 used for modeling",
    ...
    with open(
        OUTPUT_DIR
        / "experiment_7b_configuration.json",
        "w",
        encoding="utf-8",
    ) as f:
...
"""
    ...
    print(
        ...
        f"\n  {OUTPUT_DIR / 'experiment_7b_configuration.json'}"
    )
